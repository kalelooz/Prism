...
A Windows companion for personalizing the Codex desktop app with themes and image backgrounds.

Prism includes a theme library, color editing, theme import/export, image fading, and saved background setups. Images and settings are stored locally.
...
Prism is an independent project and is not affiliated with OpenAI. Codex is a product of OpenAI.
